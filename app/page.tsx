...
export default function Home() {
    ...
    return (
        <main className="bg-slate-900 text-white font-sans antialiased min-h-screen">
            ...
            <a
                href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER}?text=Hi%2C%20I%20would%20like%20to%20know%20more%20about%20your%20services`}
                target="_blank"
                rel="noopener noreferrer"
                className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 bg-[#25D366] hover:bg-[#128C7E] text-white p-2 md:p-3 rounded-full shadow-lg transition-transform hover:scale-110 active:scale-95 flex items-center justify-center animate-bounce"
                aria-label="Chat on WhatsApp"
                style={{ animationDuration: '2s', animationIterationCount: 'infinite' }}
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className="w-6 h-6 md:w-8 md:h-8">
